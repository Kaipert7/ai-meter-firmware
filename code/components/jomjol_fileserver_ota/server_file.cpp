    ...
    sort_iter = 0;
    {
        ...
        for (i = 0; i < numberoffiles; i++)
        {
            ...
            if (!file_stat.m_is_directory)
            {
                ...
                {
                    std::string _dir = get_directory(zw);
                ...
                {
                    find_replace(zw, _html_final, _html_tmp);
                }
                ...
                isokay = isokay && rename_file(filename_zw, zw);
                if (!isokay)
